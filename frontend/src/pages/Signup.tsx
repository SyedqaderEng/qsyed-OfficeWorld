...
export function Signup() {
  ...
  const handleGoogleSignup = () => {
    // Store selected plan in localStorage for redirect after Google auth
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-3xl font-bold text-gray-900">Qsyed</span>
          </div>
        ...
        {/* Selected Plan Badge */}
        {selectedPlan && (
          <div className="mb-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-lg text-center">
            <p className="text-sm text-gray-600">Selected Plan:</p>
            <p className="text-lg font-bold text-blue-600">{planNames[selectedPlan]}</p>
          </div>
        )}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full py-3 border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition font-semibold flex items-center justify-center gap-2"
            >
